...
if os.path.exists(file_path):
    ...
    # Filtra os valores da coluna A para manter apenas "PA" e "NDF"
    df_filtered = df[df['Tp'].isin(['PA', 'NDF'])].copy()  # Use .copy() para evitar SettingWithCopyWarning
    df_filtered = df_filtered[df_filtered['Natureza'].isin(['2.1601'])].copy()
    ...
    # Converte DF_soma para valores positivos
    df_filtered['DF_soma'] = df_filtered['DF_soma'].abs()
    ...
    new_filename = f'ADT_VIAGEM_{specific_file}'
