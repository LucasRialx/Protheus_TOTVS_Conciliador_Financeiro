...
if os.path.exists(file_path):
    ...
    df_normal['Soma'] = df_normal.apply(
        lambda row: abs((row['Tit Vencidos Valor Corrigido'] if pd.notna(row['Tit Vencidos Valor Corrigido']) else 0) + 
    ...
    # Usar o valor da coluna "Valor Real" como a Soma e garantir que seja positivo
    df_redec['Soma'] = abs(df_redec['Valor Real'])
    ...
    final_filename = 'ADT_CLIENTES_' + specific_file
